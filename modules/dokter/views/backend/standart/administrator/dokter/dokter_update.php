...
<section class="content-header">
    <h1>
        Dokter        <small>Edit Dokter</small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc">Edit Dokter</h5>
                            <hr>
                        </div>
                        <?= form_open(base_url('administrator/dokter/edit_save/'.$this->uri->segment(4)), [
                            'name' => 'form_dokter',
                        ...
                        <div class="form-group group-iddokter  ">
                                ...
                                <div class="col-sm-8">
                                    <input type="number" class="form-control" name="iddokter" id="iddokter" placeholder="" value="<?= set_value('iddokter', $dokter->iddokter); ?>">
                        ...
                        <div class="form-group group-nama  ">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="nama" id="nama" placeholder="" value="<?= set_value('nama', $dokter->nama); ?>">
                                    <small class="info help-block">
                        ...
                        <div class="form-group group-spesialis  ">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="spesialis" id="spesialis" placeholder="" value="<?= set_value('spesialis', $dokter->spesialis); ?>">
                                    <small class="info help-block">
    ...
    */
    ...
    $.ajax({
        ...
        .done(function(res) {
            ...
            if (res.success) {
                var id = $('#dokter_image_galery').find('li').attr('qq-file-id');
                if (save_type == 'back') {

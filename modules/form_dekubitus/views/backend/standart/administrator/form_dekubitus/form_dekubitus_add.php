...
<section class="content-header">
    <h1>
        Form Dekubitus        <small><?= cclang('new', ['Form Dekubitus']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Form Dekubitus']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                        ...
                        ?>
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="nama_pasien" id="nama_pasien" placeholder="Nama Pasien" value="<?= set_value('nama_pasien'); ?>">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="nama_ruangan" id="nama_ruangan" placeholder="Nama Ruangan" value="<?= set_value('nama_ruangan'); ?>">
                                    <small class="info help-block">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="Jam" id="Jam" placeholder="Jam" value="<?= set_value('Jam'); ?>">
                                    <small class="info help-block">
                                ...
                                <div class="col-sm-8">
                                    <div class="col-md-3 padding-left-0">
                                            <label>
                                                <input type="radio" class="flat-red" name="kondisi_fisik" value="Baik"> Baik                                            </label>
                                        </div>
                                    <div class="col-md-3 padding-left-0">
                                            <label>
                                                <input type="radio" class="flat-red" name="kondisi_fisik" value="Sedang"> Sedang                                            </label>
                                        </div>
                                    <div class="col-md-3 padding-left-0">
                                            <label>
                                                <input type="radio" class="flat-red" name="kondisi_fisik" value="Buruk"> Buruk                                            </label>
                                        </div>
                                    <div class="col-md-3 padding-left-0">
                                            <label>
                                                <input type="radio" class="flat-red" name="kondisi_fisik" value="Sangat Buruk"> Sangat Buruk                                            </label>
                                        </div>
                                    </select>
                                    <div class="row-fluid clear-both">
                                        <small class="info help-block">
                                ...
                                <div class="col-sm-8">
                                    <div class="col-md-3 padding-left-0">
                                            <label>
                                                <input type="radio" class="flat-red" name="status_mental" value="Sadar"> Sadar                                            </label>
                                        </div>
                                    <div class="col-md-3 padding-left-0">
                                            <label>
                                                <input type="radio" class="flat-red" name="status_mental" value="Apatis"> Apatis                                            </label>
                                        </div>
                                    <div class="col-md-3 padding-left-0">
                                            <label>
                                                <input type="radio" class="flat-red" name="status_mental" value="Bingung"> Bingung                                            </label>
                                        </div>
                                    <div class="col-md-3 padding-left-0">
                                            <label>
                                                <input type="radio" class="flat-red" name="status_mental" value="Stupor"> Stupor                                            </label>
                                        </div>
                                    </select>
                                    <div class="row-fluid clear-both">
                                        <small class="info help-block">
                                ...
                                <div class="col-sm-8">
                                    <div class="col-md-3 padding-left-0">
                                            <label>
                                                <input type="radio" class="flat-red" name="aktifitas" value="Jalan Sendiri"> Jalan Sendiri                                            </label>
                                        </div>
                                    <div class="col-md-3 padding-left-0">
                                            <label>
                                                <input type="radio" class="flat-red" name="aktifitas" value="Jalan dengan bantuan"> Jalan dengan bantuan                                            </label>
                                        </div>
                                    <div class="col-md-3 padding-left-0">
                                            <label>
                                                <input type="radio" class="flat-red" name="aktifitas" value="Kursi Roda"> Kursi Roda                                            </label>
                                        </div>
                                    <div class="col-md-3 padding-left-0">
                                            <label>
                                                <input type="radio" class="flat-red" name="aktifitas" value="Ditempat tidur"> Ditempat tidur                                            </label>
                                        </div>
                                    </select>
                                    <div class="row-fluid clear-both">
                                        <small class="info help-block">
                                ...
                                <div class="col-sm-8">
                                    <div class="col-md-3 padding-left-0">
                                            <label>
                                                <input type="radio" class="flat-red" name="mobilitas" value="Bebas bergerak"> Bebas bergerak                                            </label>
                                        </div>
                                    <div class="col-md-3 padding-left-0">
                                            <label>
                                                <input type="radio" class="flat-red" name="mobilitas" value="Agak Terbatas"> Agak Terbatas                                            </label>
                                        </div>
                                    <div class="col-md-3 padding-left-0">
                                            <label>
                                                <input type="radio" class="flat-red" name="mobilitas" value="Sangat Terbatas"> Sangat Terbatas                                            </label>
                                        </div>
                                    <div class="col-md-3 padding-left-0">
                                            <label>
                                                <input type="radio" class="flat-red" name="mobilitas" value="Tidak mampu bergerak"> Tidak mampu bergerak                                            </label>
                                        </div>
                                    </select>
                                    <div class="row-fluid clear-both">
                                        <small class="info help-block">
                                ...
                                <div class="col-sm-8">
                                    <div class="col-md-3 padding-left-0">
                                            <label>
                                                <input type="radio" class="flat-red" name="inkontinensia" value="Kontinen"> Kontinen                                            </label>
                                        </div>
                                    <div class="col-md-3 padding-left-0">
                                            <label>
                                                <input type="radio" class="flat-red" name="inkontinensia" value="Kadang-kadang inkontinensia  urin"> Kadang-kadang inkontinensia  urin                                            </label>
                                        </div>
                                    <div class="col-md-3 padding-left-0">
                                            <label>
                                                <input type="radio" class="flat-red" name="inkontinensia" value="Selalu inkontenensia urin"> Selalu inkontenensia urin                                            </label>
                                        </div>
                                    <div class="col-md-3 padding-left-0">
                                            <label>
                                                <input type="radio" class="flat-red" name="inkontinensia" value="inkontensia urin & alva"> inkontensia urin & alva                                            </label>
                                        </div>
                                    </select>
                                    <div class="row-fluid clear-both">
                                        <small class="info help-block">
...
<script>
   ...
   var inkontinensia = $('#inkontinensia');
    ...
    $.ajax({
            url: BASE_URL + '/administrator/form_dekubitus/add_save',
            type: 'POST',
            dataType: 'json',
            data: data_post,
        })

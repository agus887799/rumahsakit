...
class Model_pasien extends MY_Model {
    ...
    private $primary_key    = 'idpasien';
    private $table_name     = 'pasien';
    public $field_search   = ['noRM', 'nik', 'jkelamin', 'tanggal_lahir', 'alamat', 'jenis_asuransi', 'dpjp', 'ruang'];
    public $sort_option = ['idpasien', 'DESC'];

...
<section class="content-header">
    <h1>
        Pasien        <small>Edit Pasien</small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc">Edit Pasien</h5>
                            <hr>
                        </div>
                        <?= form_open(base_url('administrator/pasien/edit_save/'.$this->uri->segment(4)), [
                            'name' => 'form_pasien',
                        ...
                        <div class="form-group group-noRM  ">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="noRM" id="noRM" placeholder="" value="<?= set_value('noRM', $pasien->noRM); ?>">
                        ...
                        <div class="form-group group-nik  ">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="nik" id="nik" placeholder="" value="<?= set_value('nik', $pasien->nik); ?>">
                                    <small class="info help-block">
                        ...
                        <div class="form-group  wrapper-options-crud group-jkelamin">
                                <label for="jkelamin" class="col-sm-2 control-label">Jenis Kelamin                                    <i class="required">*</i>
                                    </label>
                                <div class="col-sm-8">
                                    <div class="col-md-3 padding-left-0">
                                            <label>
                                                <input <?= $pasien->jkelamin == "Laki-laki" ? "checked" : ""; ?> type="radio" class="flat-red" name="jkelamin" value="Laki-laki"> Laki-laki                                            </label>
                                        </div>
                                    <div class="col-md-3 padding-left-0">
                                            <label>
                                                <input <?= $pasien->jkelamin == "Perempuan" ? "checked" : ""; ?> type="radio" class="flat-red" name="jkelamin" value="Perempuan"> Perempuan                                            </label>
                                        </div>
                                    </select>
                        ...
                        <div class="form-group group-tanggal_lahir  ">
                                ...
                                <div class="col-sm-6">
                                    <div class="input-group date col-sm-8">
                                        <input type="text" class="form-control pull-right datepicker" name="tanggal_lahir" placeholder="" id="tanggal_lahir" value="<?= set_value('pasien_tanggal_lahir_name', $pasien->tanggal_lahir); ?>">
                                    </div>
                                    <small class="info help-block">
                                        </small>
                                </div>
                        ...
                        <div class="form-group group-alamat  ">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="alamat" id="alamat" placeholder="" value="<?= set_value('alamat', $pasien->alamat); ?>">
                                    <small class="info help-block">
                        ...
                        <div class="form-group group-jenis_asuransi  ">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="jenis_asuransi" id="jenis_asuransi" placeholder="" value="<?= set_value('jenis_asuransi', $pasien->jenis_asuransi); ?>">
                                    <small class="info help-block">
                        ...
                        <div class="form-group group-dpjp  ">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="dpjp" id="dpjp" placeholder="" value="<?= set_value('dpjp', $pasien->dpjp); ?>">
                                    <small class="info help-block">
                        ...
                        <div class="form-group group-ruang  ">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="ruang" id="ruang" placeholder="" value="<?= set_value('ruang', $pasien->ruang); ?>">
                                    <small class="info help-block">
   ...
   var ruang = $('#ruang');
    ...
    $.ajax({
        ...
        .done(function(res) {
            ...
            if (res.success) {
                var id = $('#pasien_image_galery').find('li').attr('qq-file-id');
                if (save_type == 'back') {
